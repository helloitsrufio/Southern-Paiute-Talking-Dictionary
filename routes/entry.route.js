...
router.post("/word/:id/update", ensureAuth, entryController.updateEntry);

// TODO: use DELETE /word/:id
//TODO: Need to make this delete, can do so successfully if you incorporate ajax/axios and fetch
router.post("/word/:id/delete", ensureAuth, entryController.deleteEntry);

//different pages. not related to the db
router.get("/word/:id/edit", ensureAuth, entryController.updateInputPage);

router.get("/input", ensureAuth, entryController.getInputPage);
